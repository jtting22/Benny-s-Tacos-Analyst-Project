...
##########################################################################################
#More Tables for Tableau

DROP TABLE yelp13_tb_1;
CREATE TABLE yelp13_tb_1 SELECT AVG(rating), alias, review_count, zip_code
FROM yelp_90013_copy
WHERE review_count > 100
GROUP BY alias;

DROP TABLE yelp14_tb_1;
CREATE TABLE yelp14_tb_1 SELECT AVG(rating), alias, review_count, zip_code
FROM yelp_90014_copy
WHERE review_count > 100
GROUP BY alias;

DROP TABLE yelp46_tb_1;
CREATE TABLE yelp46_tb_1 SELECT AVG(rating), alias, review_count, zip_code
FROM yelp_90046_copy
WHERE review_count > 100
GROUP BY alias;

DROP TABLE alias_rating_tb;
CREATE TABLE alias_rating_tb SELECT * 
FROM yelp13_tb_1
UNION SELECT * FROM yelp14_tb_1
UNION SELECT * FROM yelp46_tb_1;

SELECT * FROM alias_rating_tb;
